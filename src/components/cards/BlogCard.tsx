...
export default function BlogCard({imagepath,link}:blog){
    return(
    <Link href={link} >
        <div   className="  w-[375px] h-[450px] relative group rounded-xl overflow-hidden shadow-md " >
           ...
           <div className=" absolute inset-0 z-10 bg-gradient-to-t to-black-4/0 via-black-4/25  from-black-4/60 " />
