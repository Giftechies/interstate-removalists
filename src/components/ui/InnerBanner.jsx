...
export default function Banner({imgpath,pagename,pagepath,text}){
    return(
          ...
          className="fade-wrapper  homebanner relative overflow-hidden   bg-cover bg-center  object-cover md:p-[70px] md:m-5  md:mt-25 md:rounded-3xl before:absolute before:inset-0 before:bg-black-1/60  xxl:mx-10">
