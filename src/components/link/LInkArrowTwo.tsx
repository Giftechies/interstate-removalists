...
const LInkArrowTwo = ({
  ...
  return (
    <Link
      href={`${link}`}
      className={cn("group flex items-center gap-16 ", className)}
    >
      <span>{linkText}</span>
      ...
      <span className="relative flex items-center">
        ...
        >
          <path
            ...
            className="theme-transition-3 fill-white-1 "
          />
        </svg>
        <span
          className={cn(
            "block size-12 rounded-full border border-white-1 group-hover:border-black-1 group-hover:bg-black-4",
            roundClassName,
          )}
        ></span>
      </span>
