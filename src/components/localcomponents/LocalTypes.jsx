         ...
         spaceBetween={24}
           ...
           { localCard.map((item,id)=>{
            ...
            <div className={"smt60px z-10 mx-auto flex w-fit items-center gap-4"}>
                      <button className="customerSliderPrev theme-transition-3 flex items-center justify-center rounded-full border border-primary bg-transparent p-3 font-semibold text-primary hover:bg-prim hover:text-white-1">
                        <IconArrowLeft size={24} />
                      </button>
                      <button className="customerSliderNext theme-transition-3 flex items-center justify-center rounded-full border border-primary bg-transparent p-3 font-semibold text-primary hover:bg-prim hover:text-white-1">
