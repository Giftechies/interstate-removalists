...
const FooterSideSection = () => {
  return (
    <div className="xxl:spt120px flex flex-col items-center gap-10 bg-prim px-10 text-center max-xxl:justify-between max-xxl:py-6 lg:gap-15 lg:max-xxl:flex-row xxl:w-[508px] xxl:px-25 xxl:pb-8">
