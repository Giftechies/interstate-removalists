...
const HomeTwoServiceCard = ({ title, text, className, icon }: Props) => {
  return (
    ...
    >
      ...
      <div className="rounded-16px theme-transition-4 absolute bottom-0 left-0 flex h-0 w-full items-center justify-center  bg-secondary/60 opacity-0 group-hover:visible  group-hover:h-full group-hover:opacity-100">
