  ...
  return (
    <div className="till-card relative justify-center gap-6 max-xl:flex max-xl:items-center max-md:flex-col lg:gap-10 xl:pb-15">
      ...
      <div className="sp24px bottom-0 left-[220px] max-w-[416px] bg-white-1 shadow-custom2 max-xl:h-fit xl:absolute">
        ...
        <Link
          href={`/blog-details`}
          className="h4 theme-transition-3 mt-3 block font-medium hover:text-prim"
        >
          {title}
        </Link>
        ...
        <Link
          href={`${link}`}
          className="group theme-transition-3 mt-3 flex items-center gap-6 hover:text-prim"
        >
          ...
          >
            <IconArrowUpRight className="theme-transition-3 group-hover:text-prim" />
          </span>
        </Link>
      </div>
    </div>
