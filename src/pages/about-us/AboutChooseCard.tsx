...
const AboutChooseCard: React.FC<AboutChooseCardProps> = ({
  ...
  return (
    ...
    >
      <div className="theme-transition-3 w-fit rounded-full border border-black-4 bg-transparent p-[14px] text-black-4 group-hover:border-white-1 group-hover:bg-white-1 group-hover:text-prim">
        {icon}
      </div>
