import educationGetLoan from "@/../public/images/education-loan/education-loan-thumb-get-loan.png";
    ...
    >
      <div className="container flex justify-between gap-6 max-xl:flex-col">
        <h3 className="d2 max-w-[631px] font-medium">
          Get your Education Loan Locally
        </h3>
      ...
      <div className="spt60px spb60px flex justify-center max-xxl:container">
        <Image
          src={educationGetLoan}
          alt="Education Loan get your education loan locally"
          className="appear-down"
        />
      </div>
      <div className="container grid grid-cols-12  gap-5 md:gap-6">
        <h4 className="h2 title-animation col-start-1 col-end-13 font-semibold sm:col-end-9 lg:col-end-7">
