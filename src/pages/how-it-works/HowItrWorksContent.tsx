      ...
      <div className="container">
        <div className="grid grid-cols-12 items-center space-y-4 ">
          <div className="col-start-1 col-end-13 lg:col-end-6 xl:col-end-6 space-y-4 ">
            <span className="h5 title-animation font-medium uppercase text-prim">Our Process</span>
          ...
          <div className="spt60px spl60px spb60px relative  col-start-1 col-end-13 bg-sec text-white-1 xl:col-end-9">
            <div className="smt40px  grid grid-cols-12">
              <div className="  col-start-2 lg:col-start-1 col-end-12 relative  ">
                ...
                <div className=" max-lg:hidden absolute animate-spin-slow text-prim -top-4 -right-12 ">
