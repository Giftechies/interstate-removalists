import image from "@/../public/images/business-loan/get-loan.png";
import Lines from "@/components/shared/Lines";
import SectionText from "@/components/shared/SectionText";
import Image from "next/image";

const BusinessLoanGetLoan = () => {
  return (
    <section
    ...
    >
      ...
      <div className="spt60px spb60px flex justify-center max-xxl:container">
        <div className="overflow-hidden">
          <Image
            src={image}
            alt="Get your Business loan locally"
...
export default BusinessLoanGetLoan;
