      ...
      <div className="container  grid grid-cols-12 items-center gap-6">
        <div className="relative  col-start-1 col-end-13 grid grid-cols-1 items-center gap-6 md:grid-cols-2 xl:col-end-7 xl:grid-cols-6 xl:items-end">
          ...
          <div className=" max-sm:w-full xl:col-start-5 xl:col-end-7">
            ...
            />
            <div className="d3 max-md:hidden font-semibold text-prim">
        ...
        {
          buttonText &&(
               <HomeThreeBannerLink href="/#" className=" bg-prim rounded-full text-white-1    hover:bg-transparent hover:text-prim  hover:border-prim w-fit mt-6 " >{buttonText?  buttonText:"Get Instant Quote"}</HomeThreeBannerLink>  
          )
        }
        </div>
      </div>
