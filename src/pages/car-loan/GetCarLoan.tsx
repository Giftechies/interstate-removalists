import image from "@/../public/images/car-loan/get-car-loan.png";
  ...
  return (
    ...
    >
      <div className="container flex justify-between gap-6 max-xl:flex-col">
        <h3 className="d2 max-w-[685px] font-medium">
          Get your Car Loan Locally
        </h3>
      ...
      <div className="spt60px spb60px flex justify-center max-xxl:container">
        <Image
          src={image}
          alt="Car Loan get your car loan locally"
          className="appear-down"
        />
      </div>
      <div className="container grid grid-cols-12  gap-5 md:gap-6">
        <h4 className="h2 title-animation col-start-1 col-end-13 max-w-[300px] font-semibold sm:col-end-9 lg:col-end-5">
